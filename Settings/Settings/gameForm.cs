...
namespace Settings
{
    public partial class gameForm : Form
    {
        ...
        private static string CheckInput(string input)
        {
            ...
            /* Matches https://steamcommunity.com/id/xnooztv_main */
            var reg1 = new Regex(@"^(https?:\/\/(?:[a-z0-9-]+\.)*steamcommunity\.com.id.[a-zA-Z0-9](?:\S*)?)$");

            /* Matches http://steamcommunity.com/profiles/76561198871759336 */
        ...
        private void backgroundWorker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            gameGroup.Text = $"Jeux: {mGames.Count}";
